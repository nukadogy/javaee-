            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="widget-area-2 lochana-box-shadow">
                        <h2 class="widget-title">菜品推荐</h2>
                        <div class="table-responsive mb-3">
                            <div class="col-sm-12">


                                <h5 class="widget-title">以下为本店的菜品推荐</h5>
                                <h5 class="widget-title">可直接点击查看或者搜索感兴趣的菜品</h5>


                                <button onclick="add()" type="button" class="btn btn-success 新增">添加</button>

                                <br>
                                想试一试辣的菜吗，不妨试试  ————>  <button onclick="search2()" type="button" class="btn btn-success 点餐">吃点辣的</button>
                                <br>
                                适合小孩  ————>  <button onclick="search3()" type="button" class="btn btn-success 点餐">小孩爱吃</button>
                                <br>
                                <br>
                                <label>
                                    <input type="text" id="shangpinContent" class="form-control form-control-sm"
                                           onchange="moneyEndSearchChickValue(this)" placeholder="词语" aria-controls="tableId">
                                </label>
...
<script>
    ...
    function search2() {
        searchForm = {key: ""};
        var shangpinContent = $('#shangpinContent').val();
        shangpinContent="麻辣";
        if( shangpinContent  == 0){
            shangpinContent ='';
        }
        searchForm.shangpinContent = shangpinContent;
    ...
    function getDataList() {
        http("shangpin/page", "GET", {
            ...
            sort: sortColumn,
            order: sortOrder,
            shangpinContent: searchForm.shangpinContent,
